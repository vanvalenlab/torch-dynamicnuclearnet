...
from torch_dnn.loss import SemanticLoss, LossTracker
from torch_dnn.loaders import create_data_loaders
from torch_dnn.utils import create_sample_overlay
...
def main():
    ...
    config = {
        ...
        'data_path': Path.home() / '.deepcell/dnn/',
        'run_info': 'data/logs/',
        'epochs': 16,
        'zoom_min': 0.75,
        'batch_size': 10,
